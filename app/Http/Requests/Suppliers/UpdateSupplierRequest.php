...
class UpdateSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'contact_type' => ['sometimes', 'required', 'string', Rule::in(['individual', 'business'])],
            'supplier_code' => [
                'nullable',
                'string',
                'max:100',
            ...
            'business_name' => [
                Rule::requiredIf($this->input('contact_type', $supplier->contact_type) === 'business'),
                'nullable',
                'string',
                'max:255',
            ],
            ...
            'first_name' => [
                Rule::requiredIf($this->input('contact_type', $supplier->contact_type) === 'individual'),
                'nullable',
                'string',
                'max:255',
            ],
