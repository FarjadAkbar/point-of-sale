...
class StoreSupplierRequest extends FormRequest
{
    ...
    {
        $this->merge([
            'supplier_code' => $this->supplier_code === '' ? null : $this->supplier_code,
    ...
    public function rules(): array
    {
        ...
        return [
            'contact_type' => ['required', 'string', Rule::in(['individual', 'business'])],
            'supplier_code' => [
                'nullable',
                'string',
                'max:100',
                Rule::unique('suppliers', 'supplier_code')->where('team_id', $team->id),
            ],
            'business_name' => [
                Rule::requiredIf($this->input('contact_type') === 'business'),
                'nullable',
                'string',
                'max:255',
            ],
            ...
            'first_name' => [
                Rule::requiredIf($this->input('contact_type') === 'individual'),
                'nullable',
                'string',
                'max:255',
            ],
