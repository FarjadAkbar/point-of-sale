...
class StorePurchaseRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        foreach (['ref_no', 'shipping_details', 'additional_notes'] as $k) {
            if ($this->input($k) === '') {
                $this->merge([$k => null]);
            }
        }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status' => ['required', 'string', Rule::in(['received', 'pending', 'ordered'])],
            ...
            'lines.*.unit_cost_before_discount' => ['required', 'numeric', 'min:0'],
            'lines.*.discount_percent' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'lines.*.product_tax_percent' => ['nullable', 'numeric', 'min:0'],
            'lines.*.profit_margin_percent' => ['nullable', 'numeric', 'min:0'],
            'lines.*.unit_selling_price_inc_tax' => ['nullable', 'numeric', 'min:0'],
