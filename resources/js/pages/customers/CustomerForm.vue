...
const isBusiness = computed(() => props.form.entity_type === 'business');
const isIndividual = computed(() => props.form.entity_type === 'individual');
...
<template>
    <div class="grid gap-6">
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <div class="grid gap-2">
                <Label for="customer_code">Contact ID</Label>
                <Input
                    id="customer_code"
            ...
            >
                ...
                >
                    <Checkbox
                        ...
                        "
                    />
                    <Label :for="`cu-${m.id}`" class="font-normal">
                        {{ m.name }}
            ...
            <CollapsibleContent class="space-y-6 pt-2">
                ...
                >
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-fn`">First name *</Label>
                            <Input
                                :id="`cp${i}-fn`"
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-ln`">Last name</Label>
                            <Input
                                :id="`cp${i}-ln`"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-mo`">Mobile</Label>
                            <Input
                                :id="`cp${i}-mo`"
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-alt`">Alternate number</Label>
                            <Input :id="`cp${i}-alt`" v-model="person.alt_number" />
                        </div>
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-fam`">Family number</Label>
                            <Input
                                :id="`cp${i}-fam`"
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-dep`">Department</Label>
                            <Input
                                :id="`cp${i}-dep`"
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-des`">Designation</Label>
                            <Input
                                :id="`cp${i}-des`"
                        ...
                        <div class="grid gap-2">
                            <Label :for="`cp${i}-cm`">Commission %</Label>
                            <Input
                                :id="`cp${i}-cm`"
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="flex items-center gap-2">
                            <Checkbox
                                ...
                                "
                            />
                            <Label :for="`cp${i}-login`" class="font-normal">
                                Allow login
                            </Label>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="grid gap-2">
                                <Label :for="`cp${i}-em-login`">Email *</Label>
                                <Input
                                    :id="`cp${i}-em-login`"
                                    v-model="person.email"
                                    type="email"
                            ...
                            <div class="grid gap-2">
                                <Label :for="`cp${i}-un`">Username *</Label>
                                <Input
                                    :id="`cp${i}-un`"
                            ...
                            <div class="grid gap-2">
                                <Label :for="`cp${i}-pw`">Password</Label>
                                <Input
                                    :id="`cp${i}-pw`"
                            ...
                            <div class="flex items-center gap-2 pt-6">
                                <Checkbox
                                    ...
                                    "
                                />
                                <Label :for="`cp${i}-act`" class="font-normal">
                                    User is active
                                </Label>
                            </div>
                        </div>
